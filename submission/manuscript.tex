...
C18 Tips (Thermo Fisher Scientific, USA) accorind to the manufacturer's
instructions and sequenced on a Q Exactive Hybrid Quadrupole-Orbitrap
Mass Spectrometer (Thermo Fisher Scientific, USA). Obtaied MS/MS spectra
were searched against a protein database from metagenomic assembly
published in Burke \emph{et al.} (2011a) using SEQUEST-HIT engines and
validated with Percolator in Proteome Discoverer 2.1 (Thermo Fisher
Scientific, USA). The target-decoy approach was used to reduce the
probability of false peptide identification. Results \SI{< 1}{\percent}
false discovery rate at the peptide level were kept. For protein
identification a minimum of of two peptides and one unique peptide were
